...
from .robots.robots import H1

from .tasks.locomotion_tasks import (
    Stand,
    Walk,
    Run
)
...
class HumanoidEnv(MujocoEnv, gym.utils.EzPickle):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        model_path = "/home/davide/tdmpc2/tdmpc2/asset/unitree_h1/scene.xml" #TODO(my-rice) fix this. You need to change dynamically the path. It must not be hard coded.
